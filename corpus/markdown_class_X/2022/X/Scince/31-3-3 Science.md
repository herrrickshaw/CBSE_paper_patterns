...
source_pdf: "31-3-3 Science.pdf"
source_url: ""
pages: 15
pdf_bytes: 880958
pdf_sha256: "6305c5f3205131c2c7e2f8e8ec52f95cca68adb5c1f975c99afff04d820a9b50"
text_chars: 22355
low_text_pages: 0
...
1.      (H$) AZw_Vm§H$ 1100 W H$m H$moB© {dÚwV² VmnH$ 220 V na àMm{bV {H$`m J`m h¡ &
...
1.       (a)   An electric heater rated 1100 W operates at 220 V. Calculate
               (i) its resistance, and (ii) the current drawn by it.                     2
                                        OR

         (b)   Calculate the equivalent resistance of the following electric circuit :   2




2.       In the modern periodic table, compare the tendency of the elements to
         lose electrons while moving (i) down a group, and (ii) from left to right in
         a period.                                                                       2
31/3/3                                        3                                      P.T.O.
```
...
```
3.   ã`yQ>oZ Ho$ Xmo g§aMZmË_H$ g_md`dm| H$s g§aMZm It{ME &                                      2
...
```
3.       Draw two structural isomers of butane.                                        2
...
5.       (a)   In the given diagram, name the parts where (i) pollen grains are
         ...
         (b)   What happens to ovule and ovary after fertilisation ?                   2
...
```
6.    _mZd OZg§»`m Ho$ gmBµO H$mo {Z`§{ÌV H$aZo H$s H$moB© Xmo J^©{ZamoYr {d{Y`m± gwPmBE Am¡a
...
8.    ZrMo Xr JB© gmaUr _| Hw$N> VÎd {H$gr {deof n¡Q>Z© _| ì`dpñWV {H$E JE h¢ :
...
10.   (H$)                                   ?
      ...
      (I) ßbmpñQ>H$ An{eï> Ho$ AnKQ>Z _| An_mO©H$ (AnKQ>H$)                                   ?   3
...
```
6.       Suggest any two contraceptive methods to control the size of human
         population and explain them.                                                                        2

7.       (a)        Mendel    crossed    two     pea        plants    with    visible       contrasting
...
8.       In the following table, some elements have been arranged in a certain
         pattern :
                sa            re          ga            ma              pa            da           ni
               (do)          (re)        (mi)           (fa)           (so)          (la)         (ti)
                H             Li          Be             B              C             N            O
...
10.      (a)        What are decomposers ? State the role of decomposers in the
         ...
         (b)        Why are decomposers not helpful in decomposing the plastic
                    waste ?                                                                                  3
...
14.   ZrMo {XE JE {dÚwV² n[anW H$m AÜ``Z H$s{OE {OZ_| à{VamoYH$ VrZ ^wOmAm| A, B Am¡a C
      ...
      (H$) ^wOm C H$m Vwë` à{VamoY kmV H$s{OE &                                                1
...
14.      Study the following electric circuit in which the resistors are arranged in
         ...
         (a)   Find the equivalent resistance of arm C.                                1
