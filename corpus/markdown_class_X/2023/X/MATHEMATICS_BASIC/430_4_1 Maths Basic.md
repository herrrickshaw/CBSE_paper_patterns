---
title: "430 4 1 Maths Basic"
source_pdf: "430_4_1 Maths Basic.pdf"
source_url: ""
pages: 15
pdf_bytes: 774086
pdf_sha256: "08bb1b04d451546f5d42398937db6c19b50f29ff34c068202dec68e60c4587b7"
text_chars: 31480
low_text_pages: 1
...
1.     {ÛKmV ~hþnX {OgHo$ eyÝ`H$m| H$m `moJ VWm JwUZ\$b H«$_e: −3 Am¡a 2 h¡, h¡ :            1
             2                   2                        2                       2
       (a) x + 3x + 2 (b) x − 3x + 2               (c) x − 3x − 2           (d) x + 3x − 2
2.     70 Am¡a 40 Ho$ {bE (HCF × LCM) ~am~a h¡ :                                             1
       (a) 10             (b) 280           (c) 2800                        (d) 70
3.     EH$ AY©d¥ÎmmH$ma Mm§Xo H$s {ÌÁ`m `{X 7 go_r. h¡, Vmo Bg Mm§Xo H$m n[a_mn hmoJm :      1
       (a) 11 go_r.         (b) 14 go_r.            (c) 22 go_r.              (d) 36 go_r.

4.     g§»`m (5 − 3 5 + 5 ) EH$ :                                                            1
       (a) nyUmªH$ h¡                              (b) n[a_o` g§»`m h¡
       (c) An[a_o` g§»`m h¡                        (d) nyU© g§»`m h¡

5.     `{X ~hþnX p (x) = x2 + 5x + 6 h¡, Vmo p (− 2) H$m _mZ h¡ :                            1
       (a) 20              (b) 0                   (c) − 8                  (d) 8
6.     {ZåZ _| H$m¡Zgr g§»`m EH$ KQ>Zm H$s àm{`H$Vm Zht hmoVr h¡ ?                           1
                                 5                                                1
       (a) 0.1             (b)                     (c) 3%                   (d)
                                 3                                                3
7.     x + 2y + 5 = 0 Am¡a − 3x − 6y + 1 = 0 a¡{IH$ g_rH$aU `w½_ H$m/Ho$ :                   1
...
```
8.    `{X ∆ABC ∼ ∆DEF h¡ Am¡a ∠A = 47o, ∠E = 83o h¡, Vmo ∠C ~am~a h¡ :                          1
              o                    o                         o                       o
      (a) 47               (b) 50                   (c) 83               (d) 130
9.    `{X x − y = 1, x + ky = 5 a¡{IH$ g_rH$aU `w½_ H$m A{ÛVr` hb x = 2, y = 1 h¡, Vmo
      k H$m _mZ h¡ :                                                                            1
      (a) − 2              (b) − 3                  (c) 3                (d) 4
10.   5 sin290o − 2 cos2 0o ~am~a h¡ :                                                          1
      (a) − 2              (b) 5                    (c) 3                (d) − 3
11.   {ÌÁ`m 14 go_r. dmbo d¥Îm H$s EH$ Mmn H$s bå~mB©, Omo d¥Îm Ho$ H|$Ð na 60o H$m H$moU
      A§V[aV H$aVm h¡, h¡ :                                                                     1
            44                   88                        308                 616
      (a)      go_r.       (b)      go_r.           (c)        go_r.     (d)       go_r.
            3                     3                         3                   3

12.   30 _r. D±$Mr _rZma Ho$ nmX-q~Xþ go 30 _r. H$s Xÿar na pñWV EH$ q~Xþ go _rZma Ho$ {eIa
      H$m CÞ`Z H$moU h¡ :                                                                       1
              o                    o                         o                   o
      (a) 30               (b) 45                   (c) 60               (d) 90
13.   g§»`mAm| 2, 3, 3, 4, 5, 4, 4, 5, 3, 4, 2, 6, 7 H$m ~hþbH$ h¡ :                            1
      (a) 2                (b) 3                    (c) 4                (d) 5
14.   52 Vme Ho$ nÎmm| H$s AÀN>r àH$ma go \|$Q>r JB© EH$ JÈ>r _| go EH$ nÎmm `mÑÀN>`m {ZH$mbm
      OmVm h¡& Bg nÎmo Ho$ bmb ~oJ_ hmoZo H$s àm{`H$Vm Š`m h¡ ?                                 1
            1                    1                          1                  12
      (a)                  (b)                      (c)                  (d)
            52                   26                        13                  13

15.   EH$ {ÛKmV g_rH$aU, {OgH$m EH$ _yb 2 Am¡a _ybm| H$m `moJ eyÝ` h¡, h¡ :                     1
      (a) x2 + 4 = 0                                (b) x2 − 2 = 0
      (c) 4x2 − 1 = 0                               (d) x2 − 4 = 0
16.   {ZåZ _| H$m¡Z, {ÛKmV g_rH$aU Zht h¡ ?                                                     1
      (a) 2(x −1)2 = 4x2 − 2x + 1                   (b) 2x −x 2 = x2 + 5
      (c) ( 2 x + 3 )2 + x2 = 3x2 − 5x              (d) (x2 +2x)2 = x4 + 3 + 4x3
17.   EH$ d¥Îm na pñWV EH$ q~Xþ go d¥Îm na {H$VZr ñne© aoImE± ItMr Om gH$Vr h¢ ?                1
      (a) EH$            (b) Xmo                  (c) AZoH$             (d) eyÝ`

18.   3 go_r. {ÌÁ`m dmbo EH$ d¥Îm Ho$ EH$ ~mø q~Xþ A go ItMr JB© ñne© aoIm H$s bå~mB©
...
21.    `{X sin α = 12 h¡, Vmo (3 cos α − 4 cos3 α) H$m _mZ kmV H$s{OE&                            2

22.    (A) Cg {~§Xþ Ho$ {ZX}em§H$ kmV H$s{OE Omo q~XþAm| A (−1, 7) Am¡a B (4, −3) H$mo Omo‹S>Zo
       ...
       (B) `{X q~Xþ A (2, 3), B (−5, 6), C (6, 7) Am¡a D (p, 4) EH$ g_m§Va MVw^w©O
          ABCD Ho$ erf© hm|, Vmo p H$m _mZ kmV H$s{OE&                                            2
                                         1
23.    (A) {ÛKmV g_rH$aU 3x2 − 2x +        = 0 H$m {d{dº$H$a kmV H$s{OE Am¡a {\$a BgHo$ _ybm|
                                         3
             H$s àH¥${V kmV H$s{OE&                                                               2
                                          AWdm
                             2
       (B) {ÛKmV g_rH$aU x − x − 2 = 0 Ho$ _yb kmV H$s{OE&                                        2
24.    ~Jb _| ~Zr AmH¥${V _|, H|$Ð O> dmbo EH$ d¥Îm na pñWV
...
```
25.    ~Jb _| ~Zr AmH¥${V _| H«$_e: OP, OQ Am¡a OR na pñWV
...
26.    {ÛKmV g_rH$aU x2 + 6x + 8 Ho$ eyÝ`H$m| H$mo kmV H$s{OE Am¡a eyÝ`H$m| VWm JwUm§H$m| Ho$
       ~rM Ho$ g§~§Y H$s gË`Vm H$s Om±M H$s{OE&                                                   3
                                2
27.    {gÕ H$s{OE {H$ 1 + tan 2 A = sec2 A − 1                                                    3
                        1 + cot A

28.    (A) {H$amE na nwñVH|$ XoZo dmbo {H$gr nwñVH$mb` H$m àW_ VrZ {XZm| H$m EH$ {Z`V {H$am`m
...
29.    EH$ nmgo H$mo EH$ ~ma \|$H$m OmVm h¡& {ZåZ{b{IV H$mo àmá H$aZo H$s àm{`H$Vm kmV H$s{OE :   3
       (i) EH$ g_ A^mÁ` g§»`m             (ii) 4 go ~‹S>r g§»`m      (iii) EH$ {df_ g§»`m

30.    {ÌÁ`m 7 go_r. dmbo EH$ d¥Îm Ho$ {ÌÁ`I§S> H$m joÌ\$b kmV H$s{OE, {OgH$m H|$Ðr` H$moU
       90o h¡& gmW hr, g§JV XrK© {ÌÁ`I§S> H$m joÌ\$b ^r kmV H$s{OE&                               3
31.    (A) {gÕ H$s{OE {H$ ~mø q~Xþ go d¥Îm na ItMr JB© ñne©
           aoImAm| H$s bå~mB© ~am~a hmoVr h¢&                                                     3
                                   AWdm
       (B) H|$Ð O Ho$ Xmo g§H|$Ðr` d¥Îmm| H$s {ÌÁ`mE± 3 go_r. Am¡a
           5 go_r. h¢& ~‹S>o d¥Îm H$s Ordm AB, Omo N>moQ>o d¥Îm H$mo q~Xþ
           P na ñne© H$aVr h¡, H$s bå~mB© kmV H$s{OE&                                             3
...
32.     (A) EH$ g_Vb O_rZ na I‹S>r _rZma H$s N>m`m Cg pñW{V _| 40 _r. A{YH$ b§~r hmo
            OmVr h¡ O~$gy`© H$m CÞVm§e (altitude) 60o go KQ>H$a 30o hmo OmVm h¡& _rZma H$s
              D±$MmB© kmV H$s{OE&                                                              5
                                         AWdm
        (B) 7 _r. D±$Mo ^dZ Ho$ {eIa go EH$ Ho$~b Q>m°da Ho$ {eIa H$m CÞ`Z H$moU 60o h¡ Am¡a
            BgHo$ nmX H$m AdZ_Z H$moU 45o h¡& Q>m°da H$s D±$MmB© kmV H$s{OE&                   5
33.     (A) EH$ A.P. Ho$ àW_ 25 nXm| H$m `moJ\$b kmV H$s{OE, {OgH$m n dm± nX
            an = 5 + 6n go {X`m J`m h¡& gmW hr, Bg A.P. Ho$ 20d| nX H$m, 45d| nX go,
              AZwnmV ^r kmV H$s{OE&                                                            5
                                      AWdm
                                           2
        (B) EH$ A.P. _|, `{X Sn = 3n + 5n Am¡a ak = 164 hmo, Vmo k H$m _mZ kmV H$s{OE&         5

34.     ZrMo {X`m J`m ~§Q>Z 100 n[admam| H$s$ _m{gH$ {~Obr H$s InV H$mo Xem©Vm h¡ :
       _m{gH$ InV
...
35.     EH$ Vmn {dÚwV g§`§Ì _| nmZr O_m H$aZo Am¡a ~mX _| Bggo ^mn
        ~ZmZo Ho$ {bE ~m°`ba bJo h¢& Eogo EH$ ~m°`ba Ho$ ~rM H$m
        {hñgm ~obZmH$ma Am¡a XmoZm| {gam| H$m {hñgm AY©JmobmH$ma h¡&
                                                             7
        ~obZmH$ma ^mJ H$s bå~mB© 7 _r. Am¡a BgH$s {ÌÁ`m      _r.
                                                          2
        h¡&
...
36.    bJmVma H$B© K§Q>m| VH$ _mo~mBb ñH«$sZ H$m BñVo_mb H$aZo go Am±Im| H$s amoeZr H$_Omoa Am¡a
       {ga XX© hmoZo bJVm h¡& ~ƒo {OZH$mo ""PUBG'' IobZo H$s bV bJ OmVr h¡, OëXr hr
       VZmdJ«ñV hmo OmVo h¢& PUBG IobZo Ho$ Xþîn[aUm_m| Ho$ ~mao _| gm_m{OH$ OmJê$H$Vm ~‹T>mZo
       Ho$ {bE, EH$ {dÚmb` ‘BAN PUBG’ A{^`mZ ewê$ H$aZo H$m \¡$gbm H$aVm h¡, {Og_|
       ~ƒm| H$mo Am`VmH$ma A{^`mZ V»Vr ~ZmZo H$mo H$hVm h¡& H$jm X Ho$ EH$ {dÚmWu Ûmam ~ZmB©
       JB© A{^`mZ V»Vr {MÌ _| {XImB© JB© h¡&
...
37.    Iwer AnZo OÝ_{XZ H$s nmQ>u H$m Am`moOZ
       H$aZm MmhVr h¡& ñdmñÏ` Ho$ à{V OmJê$H$ hmoZo
       Ho$ H$maU, dh nmQ>u _| Ho$db \$b hr namogZo
       H$m \¡$gbm H$aVr h¡& dh 36 go~ Am¡a
       60 Ho$bo IarXVr h¡ Am¡a g~H$mo EH$g_mZ
       _mÌm _| \$b XoZo H$m {ZU©` boVr h¡&
       Cnamoº$ OmZH$mar Ho$ AmYma na, {ZåZ àíZm| Ho$ CÎma Xr{OE :
       (i)     A{YH$V_ {H$VZo A{V{W, Iwer Am_§{ÌV H$a gH$Vr h¡ ?                                   1
       (ii) àË`oH$ A{V{W H$mo {H$VZo go~ Am¡a Ho$bo àmá hmo§Jo ?                                   1
       (iii) (a) `{X Iwer 42 Am_ Am¡a Omo‹S>Zm Mmh|, Vmo A{YH$V_ {H$VZo A{V{W dh
                 Am_§{ÌV H$a gH$Vr h¡ ?                                                            2
                                           AWdm
430/4/1                                          12
```
...
```
           (b) `{X 1 XO©Z Ho$bm| H$m _yë` 60 é., 1 go~ H$m _yë` 15 é. Am¡a 1 Am_ H$m
                 ...
                 IM© H$aZr hmoJr ?                                                            2
38.    ZrMo ~Zo {MÌm| VWm AmH¥${V`m| H$mo Ü`mZnyd©H$ Xo{IE Am¡a àíZm| Ho$ CÎma Xr{OE :
       {MÌ H$
