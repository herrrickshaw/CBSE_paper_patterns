---
title: "430-3-1MATHEMATICS (BASIC)"
source_pdf: "430-3-1MATHEMATICS (BASIC).pdf"
source_url: ""
pages: 24
pdf_bytes: 1472685
pdf_sha256: "f56ce38cd42a979ab08d1edbce9a2dcc08d17932234027078d205f6d8855a8b5"
text_chars: 38585
low_text_pages: 1
...
```
6.        , DE || BC    AD = 2.8 cm, DB = 2.1 cm  EC = 4.8 cm
      ,  x    :                                                                     1
...
```
6.   If in the given figure, DE || BC. If AD = 2.8 cm, DB = 2.1 cm and EC = 4.8
...
```
11. In the given figure, graph of a polynomial f(x) is shown. The number of
...
430/3/1/CD1BA/22                            Page 11                                 P.T.O.
```
...
19.    (A) :  P(a, b)      a2 + b2                                   1
      ...
       (R) :   A(x1, y1)  B(x2, y2)     (x2 - x1 )2 + (y 2 - y1 )2
              
...
22.      : 4 sin2 60° tan2 45° – 2 sec2 30° tan2 60°                                    2
430/3/1/CD1BA/22                               Page 12
```
...
430/3/1/CD1BA/22                        Page 15                                   P.T.O.
```
...
31. (a)       : (sin q + cosec q)2 + (cos q + sec q)2 = 7 + tan2 q + cot2 q.        3
                                              
                           5
      (b)    cos A =      ,     :                                     3
                          13
...
```
29. Find the zeroes of the quadratic polynomial 5x2 + 3x – 2 and verify the
...
430/3/1/CD1BA/22                         Page 17                                    P.T.O.
```
...
```
33. (a)   In the given figure, AB is chord of length 6 cm of a circle of radius 5 cm.
...
430/3/1/CD1BA/22                     Page 21                                    P.T.O.
```
...
430/3/1/CD1BA/22                        Page 23                                   P.T.O.
```
...
```
430/3/1/CD1BA/22   109 A   Page 24
```