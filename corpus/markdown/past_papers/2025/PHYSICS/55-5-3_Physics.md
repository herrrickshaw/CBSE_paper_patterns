---
title: "55-5-3 Physics"
source_pdf: "55-5-3_Physics.pdf"
source_url: ""
pages: 27
pdf_bytes: 2108134
pdf_sha256: "33c84298c681f5acdf9aec97b517d449a2c8b0352afa3ea14d5a80664fefd472"
text_chars: 40621
low_text_pages: 0
...
```
  ...
  Series : YWX5Z/5                                                               SET ~ 3
                                                                    -
 Roll No.                                                         Q.P. Code      55/5/3
                                                                    -                -
                                                          -
...
```
                                                                                       #
                                    SECTION A
1.       A beam of light of wavelength 720 nm in air enters water (refractive
         index =    ). Its wavelength in water will be :

         (A)   540 nm                          (B) 480 nm
         (C)   420 nm                          (D) 720 nm
2.       A capacitor of capacitance C has reactance X in an ac circuit. If the
         capacitance and the frequency of the applied voltage are doubled, the new
         reactance will become :
         (A)   4X                              (B) 2X

         (C)                                       (D)

3.       Four point charges Q each, are held at the four corners of a square of side
         l. The amount of work done in bringing a charge Q from infinity to the
...
4.       A metal sheet is inserted between the plates of a parallel plate capacitor
...
5.       Four resistors, each of resistance R and a key K are connected as shown
...
6.       A charged particle gains a speed of 106 ms 1, when accelerated from rest
...
7.       A current of            A is maintained in a circular loop of radius 14 cm. The

         value of dipole moment associated with the loop is :
         (A)    0·019 Am2                            (B) 0·14 Am2
         (C)    0·196 Am2                            (D) 0·615 Am2
8.       Which of the following rays coming from the Sun plays an important role

         (A)    Infrared rays                        (B)    rays
         (C)    UV rays                              (D) Visible light rays

9.       The dimensions of (        ) 1, where   is permittivity and         is permeability of
         a medium, are :

         (A)    [M0 L1 T 1]                          (B) [M0 L2 T 2]
                     1   2   2                               1     1    1
         (C)    [M L T ]                             (D) [M L          T ]
10.      Which of the following electromagnetic waves has photons of largest
         momentum ?
         (A)    X-rays                               (B) AM radio waves
         (C)    Microwaves                           (D) TV waves
11.      The kinetic energy of an alpha particle is four times the kinetic energy of
...
12.   Two coherent light waves, each having amplitude a , superpose to
...
13.   Assertion (A) : During formation of a nucleus, the mass defect produced
...
21.                                3·6   1014 Hz                   6·8       1014 Hz
                                           -                                           2

 55/5/3                        Page 10 of 27
```
...
```
                                                                                     #
16.   Assertion (A) : The Balmer series in hydrogen atom spectrum is formed
...
17.   Find the effective resistance of the network of resistors between points A
      and F as shown in the figure.                                                  2




18.   A current of 5 A is passing along +X direction through a wire lying along
      X-axis. Find the magnetic field      at a point     = (3   + 4 ) m due to
      1 cm element of the wire, centered at origin.                                  2

19.
      energy approaches a target nucleus Z = 79 in head-on position. Calculate
      its distance of closest approach.                                              2

20.   (a)   A point object is placed in air at a distance R/3 in front of a convex
...
21.   The threshold frequency for a given metal is 3·6 1014 Hz. If
...
22.   (a)                         the amount of charge that can be stored on a

      (b)   A capacitor is charged by a battery to a potential difference V. It is
            disconnected from the battery and connected across another
            identical uncharged capacitor. Calculate the ratio of total energy
            stored in the combination to the initial energy stored in the
            capacitor.                                                                3


23.   (a)

      (b)   Light of wavelength 750 nm is incident normally on a slit of width
            1·5 mm. Diffraction pattern is obtained on a screen 1·0 m away
            from the slit. Find the distance of the nearest point from the
            central maxima at which the intensity is zero.                            3


24.   The magnetic moment (5J/T) of a bar magnet points along a uniform
      magnetic field 0·4 T.
      (a)   Calculate (i) the potential energy of the bar magnet, and (ii) the
            work done in turning the magnet by 180 .
      (b)   In which case is the potential energy of the magnet minimum ?             3


25.   A right-angled prism ABC (refractive index        ) is kept on a plane mirror
      as shown in the figure. A ray of light is incident normally on the face AC.




      (a)   Trace the path of the ray as it passes through the prism.
      (b)   Find the angle of deviation produced by the prism.                        3
 55/5/3                             Page 13 of 27                            P.T.O.
```
...
26.   (a)   Two small solid metal balls A and B of radii R and 2R having
...
27.   (a)   Draw the energy-band diagrams for conductors, semiconductors
...
28.   Differentiate between half-wave and full-wave rectification. With the
      help of a circuit diagram, explain the working of a full-wave rectifier.          3


 55/5/3                              Page 15 of 27                             P.T.O.
```
...
29.   A galvanometer is an instrument used to show the direction and strength
      ...
      As the current (Ig) which produces full scale deflection in the
      ...
      (i)    a      A galvanometer is converted into a voltmeter of range
...
```
      ...
      (ii)    The value of resistance of the ammeter in case (ii) will be :            1
              (A)   0·20                        (B) 0·24
              (C)   6·0                         (D) 6·25
      (iii)   A galvanometer of resistance 6     shows full scale deflection for a
...
30.
      ...
      (i)   Which of the following graphs can be used to obtain the value of
                                                                                       1
...
```
                                                                                  #
    (ii)    a     Red light, yellow light and blue light of the same intensity
    ...
    (iii)   When the frequency of the incident light is increased without
    ...
    (iv)    Which of the following graphs shows the variation of photoelectric
...
31.   (a)   (i)    Draw a ray diagram of a reflecting telescope (Cassegrain)
...
32.   (a)   (i)    Three batteries E1, E2 and E3 of emfs and internal
...
```
    ...
    (b)   (i)    Current I (= 1 A) is passing through a copper rod
          ...
          (ii)   Two point charges q1 (= 16 C) and q2(= 1 C) are placed at
                 ...
                 field E at point        = (3 m)   + (4 m) .                            5


55/5/3                               Page 25 of 27                             P.T.O.
```
...
33.   (a)   (i)    Define self-inductance of a coil. Derive the expression for the
