...
pages: 11
pdf_bytes: 619038
pdf_sha256: "7c0d6cf34116322bbd010b988e9f166286490ad3a9e23100dd610286ebb6d4ae"
text_chars: 19576
low_text_pages: 0
...
1.       (H$) `{X dV©_mZ _yë`m| na gH$b Kaoby CËnmX < 6,600                   GDP
              Adñ\$s{VH$ (deflator) 110 h¡, Vmo dmñV{dH$ gH$b Kaoby CËnmX H$s JUZm
              H$s{OE &                                                                      2

                                              AWdm
         (I) _mÝ` H$maUm| Ûmam, {ZåZ{b{IV H$mo ñQ>m°H$ d àdmh Mam| _| dJuH¥$V H$s{OE :      2
             (i)    31 _mM©, 2021 na AZ{~Ho$ _mb (Inventories) H$m _yë`
             (ii)   df© 2020 21 Ho$ Xm¡amZ ewÕ {Zdoe
2.       (H$) `{X {H$gr AW©ì`dñWm _| {Z`mo{OV ~MV, {Z`mo{OV {Zdoe go A{YH$ h¡, Vmo BgH$m
...
3.        ^maV _| Am{W©H$ {dH$mg n`m©daUr` g_ñ`mAm| H$s CËn{Îm Ho$ gmW hþAm h¡ &
...
1.      (a)   If the Gross Domestic Product at current prices is < 6,600 crore
              and GDP deflator is 110, calculate the Real Gross Domestic
              Product.                                                              2
                                           OR
...
2.      (a)   If planned savings exceed planned investments in an economy,
...
7.    MrZ Ûmam AnZmB© JB©$ Xmohao _yë`-{ZYm©aU H$s AdYmaUm H$s ì`m»`m H$s{OE &              3

8.    (H$) Am` Ho$ MH«$s` (dVw©b) àdmh Ho$ {d{^Þ MaUm| H$s g§jon _| ì`m»`m H$s{OE &         3
...
9.    `h _mZVo hþE {H$, {Zdoe _| n[adV©Z ( I) = < 4,000
      (MPC) = 0·5 h¡, {Zdoe JwUH$ (K) H$s H$m`© à{H«$`m H$s g§jon _| {ddoMZm H$s{OE &       3

10.     Am¡nMm[aH$ joÌ Ho$ 30 {_{b`Z l{_H$m| _| go _mÌ 21% (bJ^J) {Z`{_V doVZ^moJr
      amoµOJma _| _{hbmE± {Z`wº$ h¢ & ì`m»`m H$s{OE &                                       3
...
8.    (a)     Briefly explain the different phases of circular flow of income.       3
...
9.    Discuss briefly the working process of investment multiplier (K),
      assuming that Change in Investment ( I) is < 4,000 crore and Marginal
      Propensity to Consume (MPC) is 0·5.                                            3

10.                    lion formal sector workers, only about 21% are women
                                                                                     3
58/4/3                                       5                                   P.T.O.
```
...
12.   A{Y_m±J H$s AdYmaUm H$s ì`m»`m H$s{OE & A{Y_m±J H$s pñW{V H$mo ghr H$aZo _| gaH$mar
      ì`` Zr{V {H$g àH$ma ghm`H$ hmo gH$Vr h¡ ?                                                        5
...
```
11.   (a)   From the following data, show that the National Income will be
...
12.   Explain the concept of excess demand. How can government spending
      policy be helpful in correcting the situation of excess demand ?                        5
...
```
    ...
    13         13                       :
     ...
     `h gyMH$m§H$ {d{^Þ eham| Ho$ ñVa na SDG
...
```
13.   (H$) gVV {dH$mg àmßV H$aZo _| Zr{V Am`moJ gyMH$m§H$ Ûmam em{_b {H$Ýht Xmo MaUm| H$s
           ì`m»`m H$s{OE &                                                                  2
...
```
13.   (a)   Outline any two steps involved by the NITI Aayog index in
