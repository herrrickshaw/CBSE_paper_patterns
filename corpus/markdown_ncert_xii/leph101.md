---
title: "leph101"
source_pdf: "leph101.pdf"
source_url: "https://ncert.nic.in/textbook/pdf/leph101.pdf"
pages: 44
pdf_bytes: 3950051
pdf_sha256: "ebfbdf8057d7e855385b1720c1771a89d807cb45f5f3b7b79d530f1e8880209f"
text_chars: 144443
low_text_pages: 0
...
```
     Physics
                     ...
                     =                                                      ×
                                           −12
                      4 π (8.854 × 10 C N m )  [15 + (0.25)2 ] × 10 −4 m 2
                                                   2    −1            −2                 2

                                   6   –1
                     = 3.99 × 10 N C along QA.
...
(vi) Finally, Gauss’s law is based on the inverse square dependence on
   ...
   (a) Since the electric field has only an x component, for faces
       ...
       The corresponding fluxes are
                                                                               ...
                                                                               EXAMPLE 1.10
       f = E .DS = ∆S E L ⋅ ˆ
        L   L               n L =E DS cosq = –E DS, since q = 180°
                                L                 L
...
```
     Physics
       ...
       EXAMPLE 1.10
                      ...
                      the negative x direction for negative x. It is given that E = 200 î N/C
                      for x > 0 and E = –200 î N/C for x < 0. A right circular cylinder of
...
```
            Physics
                        ...
                        vector, i.e., as A = A â , the scalar A is an algebraic number. It can be
                        negative or positive. The direction of A will be the same as that of the unit
                        vector â if A > 0 and opposite to â if A < 0. When we want to restrict to
