---
title: "leph108"
source_pdf: "leph108.pdf"
source_url: "https://ncert.nic.in/textbook/pdf/leph108.pdf"
pages: 14
pdf_bytes: 1363968
pdf_sha256: "3aa3a0d342659b5ce090a76d3406d5a74eed7653f2e2ba3479f83b6008b7aea8"
text_chars: 53288
low_text_pages: 0
...
This implies that for consistency,                                                 a circuit through
                                                                                      which a time
         dΦE                                                                    dependent current
     ε0        =i                                                       (8.4) i (t) flows, (a) a loop of
         dt 
...
```
            Physics
                              ...
                              denoted by ic, and the displacement current denoted by id (= ✒0
                              (d✂E/dt)). So we have
                                                      dΦE
                                  i = i c + id = i c + ε0                                        (8.5)
                                                       dt
...
from the external fields). These replace ε0 and µ0 in the description to
...
```
                                               Physics
                                                                 ...
                                                                 point in space and time, E = 6.3 ĵ V/m. What is B at this point?
                                                 ...
                                                 EXAMPLE 8.1
                                                                 ...
                                                                 be along x-direction. Since, (+ ĵ ) × (+ k̂ ) = î , B is along the z-direction.
