---
title: "lebt110"
source_pdf: "lebt110.pdf"
source_url: "https://ncert.nic.in/textbook/pdf/lebt110.pdf"
pages: 22
pdf_bytes: 2609558
pdf_sha256: "aa0d533a519e0bdc396c1806a9ae0b67f36b11248421a043b07676159c7ce4f8"
text_chars: 77203
low_text_pages: 0
...
```
                                                    ...
                                                    was identified. This followed the identification of a number
                ...
                A bioreactor should fulfil the following requirements:
                  ...
                  3. uniform mixing of nutrients, cells and air throughout
                     ...
                     to the cultured cells
                                                                                ...
                                                                                Bioprocessing and Biomanufacturing        233
...
```
                ...
                On the basis of the design or configuration, important
                types of bioreactors are discussed below:
                   • Stirred tank reactors are the most conventional
                     bioreactors. In these reactors, agitator facilitates the
                                                                          ...
                                                                          Bioprocessing and Biomanufacturing     235
...
Chapter 10_Bioprocessing and Bio-manuf.indd 236                                                                                   23-01-2025 11:27:47
```
...
```
                ...
                as detailed below:
                   ...
                   3. production of pure, active and healthy inoculums in
                      sufficient quantity
                   4. optimisation of environmental conditions for growth
                      and product formation
                On the contrary, downstream processing consists of two
...
Chapter 10_Bioprocessing and Bio-manuf.indd 237                                                                                23-01-2025 11:27:48
```
...
Chapter 10_Bioprocessing and Bio-manuf.indd 238                                                                     23-01-2025 11:27:48
```
...
Chapter 10_Bioprocessing and Bio-manuf.indd 239                                                                23-01-2025 11:27:48
```
...
```
                                                    ...
                                                    bioprocess may be avoided by the following:
                                                        ...
                                                        3. sterilising all the materials to be added to the
...
Chapter 10_Bioprocessing and Bio-manuf.indd 240                                                                     23-01-2025 11:27:48
```
...
```
                ...
                cells become limited due to the concentration of one or more
...
Chapter 10_Bioprocessing and Bio-manuf.indd 241                                                                                     23-01-2025 11:27:48
```
...
```
                                                             ...
                                                             efficient way which involves efficient separation and
...
Chapter 10_Bioprocessing and Bio-manuf.indd 242                                                                                             23-01-2025 11:27:49
```
...
```
                ...
                physical, chemical and biological methods.
                     Physical methods include the mechanical means
...
Chapter 10_Bioprocessing and Bio-manuf.indd 243                                                              23-01-2025 11:27:49
```
...
```
                                                    ...
                                                    purification techniques are discussed below:
                                                      • Precipitation is a technique widely used for the
                                                        recovery of proteins and antibiotics. It can be
...
Chapter 10_Bioprocessing and Bio-manuf.indd 244                                                                  23-01-2025 11:27:49
```
...
```
                size from 0.1 to 10 µm, while in ultrafiltration, it ranges
                0.01 – 0.1 µm.
                Table 10.1: Different types of filtration processes
                  ...
                  Process                     Size Cutoff                                       Material Retained
                                                              Wt. Cutoff        Drop (psi)
                                                                                                ...
                                                                                                Suspended material
                  Microfiltration             0.1–10 µm       <1000,000 Da 10
                                                                                                (bacteria, etc.)
                                                              300-300,000                       Biological, colloids,
                  Ultrafiltration             0.01–0.1 µm                       10–100
                                                              Da                                macromolecules

                  Reverse                                                                       All suspended and
                                              <0.001 µm       <300 Da           100–800
                  osmosis                                                                       dissolved materials
                ...
                phase [Fig. 10.7(a)]. As the water moves to saline phase,
...
Chapter 10_Bioprocessing and Bio-manuf.indd 245                                                                                    23-01-2025 11:27:49
```
...
```
                ...
                Fig. 10.8: Dialysis                                 from a high to low concentration
                                               ...
                                               membrane are equal.
                                                    ...
                                                    Table 10.3.
                                                       Since time immemorial, yeasts have been used for
...
Chapter 10_Bioprocessing and Bio-manuf.indd 246                                                                23-01-2025 11:27:49
```
...
```
                ...
                Table 10.3: Some of the major products of bioprocesses at commercial level
                  ...
                  Taxol                           Plant alkaloids         Taxus brevifolia
                   ...
                   Antibiotics    production    is   another    significant
...
Chapter 10_Bioprocessing and Bio-manuf.indd 247                                                                             23-01-2025 11:27:49
```
...
```
                                                    ...
                                                    Statins produced by the yeast Monascus purpureus have
...
Chapter 10_Bioprocessing and Bio-manuf.indd 248                                                                  23-01-2025 11:27:49
```
...
Chapter 10_Bioprocessing and Bio-manuf.indd 249                                                              23-01-2025 11:27:49
```
...
```
                                                    ...
                                                    •   Primary metabolites are essential for the growth and
                                                        ...
                                                        metabolites have diverse functions in defense system,
...
Chapter 10_Bioprocessing and Bio-manuf.indd 250                                                                     23-01-2025 11:27:49
```
...
```
                ...
                •     Many desired products of animals, plants and microbial
                 ...
                 1. Differentiate between primary and secondary metabolites
                    based on their functions with example.
                 ...
                 4. Explain the basic operational stages of a bioprocess using
                    concept map.
...
Chapter 10_Bioprocessing and Bio-manuf.indd 251                                                                      23-01-2025 11:27:49
```
...
Chapter 10_Bioprocessing and Bio-manuf.indd 252                                                                23-01-2025 11:27:49
```