---
title: "leca102"
source_pdf: "leca102.pdf"
source_url: "https://ncert.nic.in/textbook/pdf/leca102.pdf"
pages: 70
pdf_bytes: 9379661
pdf_sha256: "8959d16e711a4738c8cdb53f6eee89a65a1f0a34c5993ae16d7f968a01c10754"
text_chars: 166795
low_text_pages: 0
...
(See Box 2.1 at page18)                                             Figure 2.5
  ...
  or formulas. There are no ‘side effects’ to calculating a formula: the
...
```
        ...
        formula) and shown in f o rmula bar. In case any basic values are
...
```
     ...
     column of the array.
                  ...
                  The syntax is LOOKUP (lookup_value, lookup_vector, r esult_vector)
...
```
     ...
     calculation is based on future cash flows.
              n                     If n is the number of cash flows in the list of
                      valuesi
     NPV = ∑                        values, the formula for NPV is:
             i −1    (1 + rate )i
...
2.2 DATA ENTRY, TEXT MANAGEMENT AND CELL
    FORMATTING
...
```
                                           ...
                                           s    Enter the Names of Employees in the
...
```
     ...
     §   If the formula is correct but the result is still a negative value, we can display the
         ...
         1. On the Home tab, in the Cells group, click F o rm a t, click F o rmat Cells, and
...
Spreadsheet
  ...
  Summary
   ...
   • A function is a special key word which can be entered into a cell in order to
     ...
     a function button on the formula toolbar (f x); which function offers assistance   79
