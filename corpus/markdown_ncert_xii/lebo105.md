---
title: "lebo105"
source_pdf: "lebo105.pdf"
source_url: "https://ncert.nic.in/textbook/pdf/lebo105.pdf"
pages: 31
pdf_bytes: 4133881
pdf_sha256: "21d77cdaf37c11b26956bbdae0b9eff9700d723135ac55c1a2141b1caee8f017"
text_chars: 77439
low_text_pages: 0
...
5.6   Genetic Code             DNA – deoxyribonucleic acid – is the genetic material, at
                               least for the majority of organisms. In class XI you have
5.7   Translation
                               learnt that nucleic acids are polymers of nucleotides.
5.8   Regulation of Gene            Deoxyribonucleic acid (DNA) and ribonucleic acid
      Expression               (RNA) are the two types of nucleic acids found in living
5.9   Human Genome Project     systems. DNA acts as the genetic material in most of the
                               organisms. RNA though it also acts as a genetic material
5.10 DNA Fingerprinting        in some viruses, mostly functions as a messenger. RNA
...
```
                 ...
                 Figure 5.2 Double stranded polynucleotide chain
                                                          ...
                                                          between a bp in a h e l i x i s
     ...
     Figure 5.3 DNA double helix                 information flows from DNAàRNAàProtein.
...
0.34 × 10-9 m/bp), it comes out to be approximately
...
not have a defined nucleus, the DNA is not scattered              Figure 5.4a Nucleosome
...
Both the amino acid residues carry positive charges Figure 5.4b EM picture - ‘Beads-on-String’
...
phosphorus and some others on medium that contained radioactive sulfur.         85
...
mutate at a faster rate. Consequently, viruses having RNA genome and            87
...
Figure 5.6 Watson-Crick model for complementary strands. After the completion of
...
90   polarity 5' à3' ), it is discontinuous. The discontinuously synthesised
...
92        promoter. Some of the properties of these sequences shall be discussed
...
96               also act as initiator codon.
...
to bind to and thus, be close enough                           Figure 5.13 Translation
...
of a polypeptide, it can be regulated at several levels. In eukaryotes, the              99
...
104   creativity of tens of thousands of scientists from varied disciplines in both
...
sequencing the DNA every time would be a daunting and expensive
                                                           6
task. Imagine trying to compare two sets of 3 × 10 base pairs. DNA
