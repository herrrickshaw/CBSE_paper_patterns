---
title: "lech102"
source_pdf: "lech102.pdf"
source_url: "https://ncert.nic.in/textbook/pdf/lech102.pdf"
pages: 30
pdf_bytes: 4383876
pdf_sha256: "ca0f380fbfe6a0a4363251a646aafe451fe99c5fc8dba1aa9317438d2bc8705a"
text_chars: 117635
low_text_pages: 0
...
· describe an electrochemical cell
    and differentiate between galvanic      Chemical reactions can be used to produce electrical energy,
...
· apply Nernst equation for
    ...
    the cell;                               Electrochemistry is the study of production of
· derive relation between standard          electricity from energy released during spontaneous
    potential of the cell, Gibbs energy     chemical reactions and the use of electrical energy
    of cell reaction and its equilibrium    to bring about non-spontaneous chemical
    constant;                               transformations. The subject is of importance both
· define resistivity (r), conductivity      for theoretical and practical considerations. A large
    (k) and molar conductivity (✆m) of      number of metals, sodium hydroxide, chlorine,
    ionic solutions;
...
· differentiate        between      ionic
    ...
    conductivity;                           convert chemical energy into electrical energy and are
· describe         the    method      for   used on a large scale in various instruments and
    measurement of conductivity of          devices. The reactions carried out electrochemically
    electrolytic      solutions      and    can be energy efficient and less polluting. Therefore,
    calculation of their molar              study of electrochemistry is important for creating new
    conductivity;                           technologies that are ecofriendly. The transmission of
· justify       the     variation      of   sensory signals through cells to brain and vice versa
    conductivity         and      molar     and communication between the cells are known to
    ...
    define m (molar conductivity at       this Unit, we will cover only some of its important
    zero concentration or infinite          elementary aspects.
    dilution);
  ...
  -ve             bridge              +ve
                                                                                                      When Eext = 1.1 V
                                                                                                        (i) No flow of
                                                                                                            ...
                                                                                                            current.
                                                                                                       (ii) No chemical
            ZnSO4             CuSO4                                   ZnSO4              CuSO4              reaction.
       When Eext < 1.1 V                                                      Eext >1.1
         (i) Electrons flow from Zn rod to                 (c)
             Cu rod hence current flows
             from Cu to Zn.                                                                     When Eext > 1.1 V
        (ii) Zn dissolves at anode and                                              e–
                                                                                                  (i) Electrons flow
             copper deposits at cathode.                Cathode               Current     Anode       from Cu to Zn
                                                            +ve                           –ve         and current flows
                                                           Zn                               Cu        from Zn to Cu.
Fig. 2.2                                                                                         (ii) Zinc is deposited
Functioning of Daniell                                                                                at the zinc
cell when external                                                                                    electrode and
voltage Eext opposing the                                                                             copper dissolves at
cell potential is applied.                                                                            copper electrode.
...
```
2.2 Galvanic Cells   As mentioned earlier a galvanic cell is an electrochemical cell that
...
```
                       ...
                       electrode acts as an anode. The cell can be represented as:
                               ...
                               and we have Ecell = Eright – Eleft = EAg úAg – ECu úCu
                                                                       +         2+           (2.7)
2.2.1                 The potential of individual half-cell cannot be measured. We can
Measurement           measure only the difference between the two half-cell potentials that
of Electrode          gives the emf of the cell. If we arbitrarily choose the potential of one
Potential             electrode (half-cell) then that of the other can be determined with respect
...
Fig. 2.3: Standard Hydrogen Electrode (SHE).      solution is one molar.
...
then the cell potential is equal to standard electrode potential, E oR of
the given half-cell.
         E o = E oR – E oL
     As E oL for standard hydrogen electrode is zero.
           o     o          o
         E = E R – 0 = E R
     The measured emf of the cell:
                                  +                  2+
         Pt(s) ç H2(g, 1 bar) ç H (aq, 1 M) çç Cu (aq, 1 M) ú Cu
...
of the half-cell corresponding to the reaction:
     ...
     Similarly, the measured emf of the cell:
                                  +                 2+
         Pt(s) ç H2(g, 1 bar) ç H (aq, 1 M) çç Zn (aq, 1M) ç Zn
...
half-cell reaction:
    ...
    The positive value of the standard electrode potential in the first
                        2+                                    +
case indicates that Cu ions get reduced more easily than H ions. The
...
and we obtain the equation:
        ...
        emf of the cell = E cell = E oR – E oL
                            o
...
```
            ...
            2.3 Consult the table of standard electrode potentials and suggest three
                substances that can oxidise ferrous ions under suitable conditions.



2.3 Nernst            We have assumed in the previous section that the concentration of all
    Equation          the species involved in the electrode reaction is unity. This need not be
                      ...
                      standard hydrogen electrode can be represented by:
                         ...
                         but concentration of solid M is taken as unity and we have
                          ...
                          E (o n +                                                       –1  –1
                                  ) has already been defined, R is gas constant (8.314 JK mol ),
                             M       /M
...
Ions are present as aqueous species and H2O as liquid; gases and solids are shown by g and s.
     ...
     Increasing strength of oxidising agent                                                                                   Increasing strength of reducing agent
                                                          +         –
                                                     Ag + e                                             ® Ag(s)                                                             0.80
                                                          3+            –
                                                     Fe         +e                                      ® Fe2+                                                              0.77
 ...
 1. A negative E o means that the redox couple is a stronger reducing agent than the H+/H2 couple.
 2. A positive E o means that the redox couple is a weaker reducing agent than the H+/H2 couple.
...
```
                 ...
                 electrodes and thus for the following cell
                    ...
                    Nernst equation can be written as:
                                                        RT
                        E(cell) = E(ocell ) – nF 1nQ

                                                        RT        [C]c [D]d
                                     = E(ocell ) – nF ln [A]a [B]b                                           (2.13)
...
```
 Represent the cell in which the following reaction takes place                                Example 2.1
 Mg(s) + 2Ag+(0.0001M) ® Mg2+(0.130M) + 2Ag(s)
 Calculate its E(cell) if E(ocell ) = 3.17 V.

 The cell can be written as Mgú Mg2+(0.130M)úú Ag+(0.0001M)ú Ag                                Solution
                             RT    Mg 2 +
  E cell  = E (ocell ) –      ln        2
                             2F    Ag +

                                0.059V       0.130
            = 3.17 V –                 log           = 3.17 V – 0.21V = 2.96 V.
                                   2       (0.0001)2


2.3.1 Equilibrium                 If the circuit in Daniell cell (Fig. 2.1) is closed then we note that the reaction
      Constant                           Zn(s) + Cu2+(aq) ® Zn2+(aq) + Cu(s)                        (2.1)
      from Nernst
                                      takes place and as time passes, the concentration of Zn 2+ keeps
      Equation
                                  ...
                                  in the concentration of Cu 2+ and Zn2+ ions and at the same time,
                                  ...
                                  attained. In this situation the Nernst equation may be written as:
                                      ...
                                      and at T = 298K the above equation can be written as
                                                         0.059 V
                                          E(ocell ) =            log KC = 1.1 V               ( E(ocell ) = 1.1V)
                                                            2
                                                          (1.1V × 2)
                                          log KC =                    37.288
                                                           0.059 V
                                  ...
                                  measure otherwise, can be calculated from the corresponding E o value
                                  of the cell.
...
```
                              Example 2.2 Calculate the equilibrium constant of the reaction:
                                               Cu(s) + 2Ag+(aq) ® Cu2+(aq) + 2Ag(s)
                                                    Eo(cell ) = 0.46 V
                                                        0.059 V
                                   Solution E(ocell)         =    log KC = 0.46 V or
                                                           2
                                                        0.46 V × 2
                                               log KC = 0.059 V = 15.6
...
2.3.2 Electro-          Electrical work done in one second is equal to electrical potential
      chemical          multiplied by total charge passed. If we want to obtain maximum work
      Cell and          from a galvanic cell then charge has to be passed reversibly. The
      Gibbs             reversible work done by a galvanic cell is equal to decrease in its Gibbs
      Energy of         energy and therefore, if the emf of the cell is E and nF is the amount
      the Reaction      of charge passed and DrG is the Gibbs energy of the reaction, then
                                DrG = – nFE(cell)                                           (2.15)
                        ...
                        E(cell) = E(ocell ) and we have
                                                o
                                DrG o = – nF E(cell)                                        (2.16)
                                                                         o
                           Thus, from the measurement of E         we can obtain an important
                                                                         (cell )
                                                     o
                        thermodynamic quantity, DrG , standard Gibbs energy of the reaction.
                        From the latter we can calculate equilibrium constant by the equation:
                              DrGo = –RT ln K.


            Example 2.3 The standard electrode potential for Daniell cell is 1.1V. Calculate
                          the standard Gibbs energy for the reaction:
                             Zn(s) + Cu2+(aq) ¾® Zn2+(aq) + Cu(s)
                           o         o
               Solution DrG = – nF E(cell)
...
```
    ...
    2.6 The cell in which the following reaction occurs:
         2Fe3 + (aq ) + 2I− ( aq ) → 2Fe 2 + ( aq ) + I2 (s ) has Ecell
                                                                   o
                                                                        = 0.236 V at 298 K.
...
2.4 Conductance        It is necessary to define a few terms before we consider the subject of
    ...
    Solutions          which in terms of SI base units is equal to (kg m2)/(S 3 A2). It can be
...
```
                                    Table 2.2: The values of Conductivity of some Selected
...
2.4.1 Measurement        We know that accurate measurement of an unknown resistance can be
      of the             performed on a Wheatstone bridge. However, for measuring the resistance
      Conductivity       of an ionic solution we face two problems. Firstly, passing direct current
      of Ionic           (DC) changes the composition of the solution. Secondly, a solution cannot
      Solutions          be connected to the bridge like a metallic wire or other solid conductor.
...
conductivity cells.      Platinized Pt electrode               Platinized Pt electrode
                       ...
                       Table 2.3: Conductivity and Molar conductivity of KCl solutions
                        ...
                        Concentration/Molarity           Conductivity       Molar Conductivity
                         ...
                         0.010        10.00          0.00141     0.141    141.0        141.0×10–4
                                                 ...
                                                 having the unknown resistance R 2 . The
...
Fig. 2.5: Arrangement for measurement of                                       R1 R 4
          resistance of a solution of an              Unknown resistance R2 =                 (2.19)
                                                                                 R3
          electrolyte.
...
Resistance of a conductivity cell filled with 0.1 mol L–1 KCl solution is             Example 2.4
...
```
                            and                       Lm = k × 1000 cm3 L–1 molarity–1
                                                             0.248×10 –2 S cm –1 ×1000 cm 3 L–1
                                                         =
                                                                       0.02 mol L–1
                                                         = 124 S cm2 mol–1

     Example 2.5 The electrical resistance of a column of 0.05 mol L–1 NaOH solution of
                      diameter 1 cm and length 50 cm is 5.55 × 103 ohm. Calculate its
                      resistivity, conductivity and molar conductivity.
            Solution A = p r2 = 3.14 × 0.52 cm2 = 0.785 cm2 = 0.785 × 10–4 m2
                      l = 50 cm = 0.5 m
                            l                     RA   5.55  103   0.785 cm 2
                      R =             or                                       = 87.135 W cm
                             A                      l            50 cm
...
2.4.2 Variation of      Both conductivity and molar conductivity change with the
      Conductivity      concentration of the electrolyte. Conductivity always decreases with
      and Molar         decrease in concentration both, for weak and strong electrolytes.
      Conductivity      This can be explained by the fact that the number of ions per unit
      with              volume that carry the current in a solution decreases on dilution.
      Concentration     The conductivity of a solution at any given concentration is the
...
```
                         ...
                         of unit length. This is clear from the equation:
                             G =  A =  (both A and l are unity in their appropriate units in
                                    l
                         m or cm)
...
Fig. 2.6: Molar conductivity versus c½ for acetic           conductivity and is represented by the
          acid (weak electrolyte) and potassium             symbol L°m . The variation in Lm with
          chloride (strong electrolyte) in aqueous          concentration is different (Fig. 2.6) for
          solutions.                                        strong and weak electrolytes.
                         Strong Electrolytes
                         For strong electrolytes, Lm increases slowly with dilution and can be
                         represented by the equation:
                                 Lm = L°m – A c ½                                              (2.23)
                             It can be seen that if we plot (Fig. 2.6) L m against
...
```
      Example 2.6 The molar conductivity of KCl solutions at different concentrations at
                     298 K are given below:

                                 c/mol L–1              Lm/S cm2 mol–1
                                 0.000198                  148.61
                                 0.000309                  148.29
                                 0.000521                  147.81
                                 0.000989                  147.09
            ...
            Solution Taking the square root of concentration we obtain:
                             c1/2/(mol L–1 )1/2          Lm/S cm2mol–1
                                  0.01407                  148.61
                                  0.01758                  148.29
                                  0.02283                  147.81
                                  0.03145                  147.09
...
at 298 K:
       L°m (KCl) – L°m (NaCl) = L°m (KBr) – L°m (NaBr)
            = L°m (KI) – L°m (NaI) ≃ 23.4 S cm2 mol–1
   and similarly it was found that
      L°m (NaBr)– L°m (NaCl) = L°m (KBr) – L°m (KCl) ≃ 1.8 S cm2 mol–1
...
if l°Na+ and l°Cl– are limiting molar conductivity of the sodium and chloride
ions respectively, then the limiting molar conductivity for sodium chloride
is given by the equation:
          L°m (NaCl) = l°Na+ + l°Cl–                                   (2.24)
...
anions then its limiting molar conductivity is given by:
            L°m = n+ l°+ + n– l°–                                          (2.25)
   Here, l°+ and l°– are the limiting molar conductivities of the cation
...
```
                          ...
                          concentration c to limiting molar conductivity, L m . Thus we have:
                                                                             0
                          ...
                          calculate Lm for any electrolyte from the lo of individual ions. Moreover,
                                      0


                          for weak electrolytes like acetic acid it is possible to determine the value
                          of its dissociation constant once we know the L m and Lm at a given
                                                                                 0
     ...
     Example 2.7 Calculate L m for CaCl2 and MgSO4 from the data given in Table 3.4.
                                                    0



        Solution We know from Kohlrausch law that
                         m CaCl  = Ca  2Cl = 119.0 S cm2 mol–1 + 2(76.3) S cm2 mol–1
                                    2
                                                            2+       –
                                                ...
                                                = 271.6 S cm2 mol–1
                         m  MgSO  = Mg  SO = 106.0 S cm2 mol–1 + 160.0 S cm2 mol–1
                                        4
                                                            2+       2–
                                                                     4
     ...
     Example 2.8 L m for NaCl, HCl and NaAc are 126.4, 425.9 and 91.0 S cm2 mol–1
                            0


                        respectively. Calculate L for HAc.
                                                                              0


                                                                                                       
            Solution m  HAc                 =  H+   Ac –   H+   Cl –   Ac –   Na+   Cl –   Na+
                                                = m  HCl   m  NaAc   m  NaCl 
                                                = (425.9 + 91.0 – 126.4 ) S cm2 mol –1
                                                = 390.5 S cm2 mol–1 .

      Example 2.9 The conductivity of 0.001028 mol L–1 acetic acid is 4.95 × 10–5 S cm–1.
                        Calculate its dissociation constant if L m for acetic acid is
                                                                                                  0


                        390.5 S cm2 mol–1.
                                                 4.95 105 S cm 1 1000 cm 3
            Solution m  = c                                                = 48.15 S cm3 mol–1
                                                  0.001028 mol L1      L
                                  m 48.15 S cm 2 mol 1
                        a       =    390.5 S cm 2 mol 1 = 0.1233
                                            m


                                          c 2     0.001028 mol L–1  (0.1233)2 = 1.78 × 10–5 mol L–1
                        k       =                
                                        1             1  0.1233
...
2.5 Electrolytic      In an electrolytic cell external source of voltage is used to bring about
                      a chemical reaction. The electrochemical processes are of great importance
    Cells and         in the laboratory and the chemical industry. One of the simplest electrolytic
    Electrolysis      cell consists of two copper strips dipping in an aqueous solution of
...
```
                     ...
                     the symbol F.
                         ...
                         For the electrode reactions:
                              ...
                              Al3+(l) + 3e– ¾® Al(s)                                       (2.32)
                                                            2+       3+
                         It is obvious that one mole of Mg and Al require 2 mol of electrons
      ...
      Example 2.10 A solution of CuSO4 is electrolysed for 10 minutes with a current of
                     1.5 amperes. What is the mass of copper deposited at the cathode?
            Solution t = 600 s charge = current × time = 1.5 A × 600 s = 900 C
...
2.5.1 Products of    Products of electrolysis depend on the nature of material being
      Electrolysis   electrolysed and the type of electrodes being used. If the electrode is
...
reactions:
       Na+ (aq) + e– ® Na (s)                E(ocell ) = – 2.71 V

       H+ (aq) + e– ® ½ H2 (g)               E(ocell ) = 0.00 V
   The reaction with higher value of E o is preferred and therefore, the
...
of (2.33) and (2.34) and we have
   ...
   At the anode the following oxidation reactions are possible:
       Cl– (aq) ® ½ Cl2 (g) + e–             E(ocell ) = 1.36 V       (2.36)

       2H2O (l ) ® O2 (g) + 4H+(aq) + 4e–    E(ocell ) = 1.23 V       (2.37)
...
are possible at the anode:
       2H2O(l ) ® O2(g) + 4H+(aq) + 4e–       E(ocell ) = +1.23 V     (2.38)
...
```
                               2SO42– (aq) ® S2O82– (aq) + 2e–      E(ocell ) = 1.96 V      (2.39)
...
2.6 Batteries          Any battery (actually it may have one or more than one cell connected
...
2.6.1 Primary             In the primary batteries, the reaction occurs only once and after use
...
Fig. 2.8: A commercial dry cell       cathode. The electrolyte is a paste of KOH and ZnO. The
          consists of a graphite      electrode reactions for the cell are given below:
          (carbon) cathode in a           Anode:      Zn(Hg) + 2OH– ¾® ZnO(s) + H2O + 2e–
          zinc container; the latter
          acts as the anode.              Cathode: HgO + H2O + 2e– ¾® Hg(l ) + 2OH–
...
Fig. 2.9                                                 life as the overall reaction does not
Commonly used                                            involve any ion in solution whose
...
2.6.2 Secondary       A secondary cell after use can be recharged by passing current
      Batteries       through it in the opposite direction so that it can be used again. A
                      ...
                      lead dioxide (PbO 2 ) as cathode. A 38% solution of sulphuric acid
...
2.8 Corrosion            Corrosion slowly coats the surfaces of metallic objects with oxides or
...
Oxidation: Fe (s)® Fe2+ (aq) +2e–                            essentially as an electrochemical
Reduction: O2 (g) + 4H+(aq) +4e– ® 2H2O(l)
                                                             phenomenon. At a particular spot
Atomospheric
              2+                                        +
oxidation: 2Fe (aq) + 2H2O(l) + ½O2(g) ® Fe2O3(s) + 4H (aq)
                                                             (Fig. 2.13) of an object made of iron,
                                                             oxidation takes place and that spot
        Fig. 2.13: Corrosion of iron in atmosphere           behaves   as anode and we can write
                                                             the reaction
                            Anode: 2 Fe (s) ¾® 2 Fe2+ + 4 e–             E o(Fe2+/Fe) = – 0.44 V
                        ...
                        atmosphere). This spot behaves as cathode with the reaction
                            ...
                            2Fe(s) + O2(g) + 4H+(aq) ¾® 2Fe2 +(aq) + 2 H2O (l)         E o(cell) =1.67 V
...
```
            ...
            can be obtained by taking the difference of the standard potentials of cathode and
                       o
            anode ( E(cell ) = E ocathode – E oanode). The standard potential of the cells are
                                                                o
            related to standard Gibbs energy (DrGo = –nF E(cell ) ) and equilibrium constant
...
2.6   In the button cells widely used in watches and other devices the following
      ...
      Determine Dr Go and E o for the reaction.
...
```
            2.10   The conductivity of sodium chloride at 298 K has been determined at different
                   ...
                   Find the value of 0m .
            2.11   Conductivity of 0.00241 M acetic acid is 7.896 × 10–5 S cm–1. Calculate its
                   molar conductivity. If 0m for acetic acid is 390.5 S cm2 mol–1, what is its
      ...
      2.6 ∆ r Go = −45.54 kJ mol −1 , Kc = 9.62 ×107
