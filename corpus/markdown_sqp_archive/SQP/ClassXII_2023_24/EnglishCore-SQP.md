...
source_url: "https://cbseacademic.nic.in/web_material/SQP/ClassXII_2024_25/EnglishCore-SQP.pdf"
pages: 11
pdf_bytes: 321956
pdf_sha256: "fb9d6689955a4ed23773a1d5260cd6434128f7156b5e1627309d2bc9a603e1a9"
text_chars: 32074
low_text_pages: 0
...
Answer the following questions, based on the passage above.
  i  Select the option that classifies Arthur's confusion about drastic events such as the                     1
  ...
  ii What is the significance of the white lab mouse in the control room of the Heart of Gold                  1
     spaceship?
 ...
 iii Share evidence from the text, in about 40 words to support the view that the writer’s writing             2
...
(1)    survey conducted among young adults aged 18-25 aimed to explore the reasons behind their travel
...
(2)    and freedom (58%), followed closely by the opportunity for introspection and self-discovery (52%).
...
(4)    experiences (40% for solo travellers, 36% for group travellers). Similarly, both groups valued the
...
Answer the following questions, based on given passage.
  i  Infer two possible ways that the survey , mentioned in paragraph (1) could be beneficial.            2
     Answer in about 40 words.
  ii Which travel choice point of the survey would influence tour operators to incorporate group          1
 ...
 iii What do the top choices in the survey, for traveling solo and in a group suggest about young         1
     adults?
 iv Identify the solo traveller from the following three travellers:                                      1
  ...
  v Which of the following is an example of an opportunity for self-discovery, as mentioned in            1
     paragraph 2?
                                                                                          Page 3 of 11
```
...
vi     How might the differences in budget priorities between solo and group travellers impact the          2
...
A.    Climate change is one of the most hotly contested environmental debates of our time. Will the West
 ...
 i    How does the absence of a human population in Antarctica make it significant in the climate       1
      change debate?
...
iii   The analogy of a time machine is an appropriate analogy for the role of carbon records in            1
...
ii    In the given extract, what emotion were the astrologers feeling when they "bit their lips            1
      and swallowed hard"?
        ...
        C. Grief
        D. Unease
iii    Which trait are the astrologers lauding when they say "warrior of warriors, hero of heroes,         1
...
```
iv    Pick evidence from the extract that helps one infer that this was not the protagonist’s first                      1
...
B     Unaware of what his name represents, he roams the streets with his friends, an army of barefoot
      ...
      (Lost Spring)
 i    What is the writer’s purpose in allowing the boys to speak for themselves via dialogue, as            1
...
iii   Explain any one possible inference that can be drawn from the line, "an army of barefoot         1
      boys who appear like the morning birds and disappear at noon”.
iv    Identify the line from the text that bears evidence to the fact that the writer's association    1
      with the boys is not a recent one.
v     Based on the context provided in the extract, select the most likely comment that the writer     1
